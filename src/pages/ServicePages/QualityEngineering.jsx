  ...
  return (
    <>
      <AboutBanner
        ...
        desc='Transform your business with Yasya’s Quality Engineering services. We design, develop, and deliver scalable, high-performance software products that drive real business value. From concept to launch and beyond, our expert team ensures your product stands out in the market.'
        cta={true}
        bgImage={yourNewImage}
      />

      <OurStrengths
        subTitle='Embedding Quality at Every Stage of the Digital Lifecycle'
        title="Quality Engineering"
        desc='We adopt a shift-left quality strategy that embeds testing from day one. Our QE teams combine domain expertise with cutting-edge automation frameworks to ensure every release meets the highest standards of performance, security, and user experience. We cover the full spectrum – from unit tests to enterprise-wide regression suites.'
      ...
      <CounterComp
        ...
        title={<>Quality Engineering <br /> Outcomes & Impact</>}
        counters={[
