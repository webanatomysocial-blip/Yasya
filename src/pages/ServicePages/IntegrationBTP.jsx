    ...
    return (
        <>
            <AboutBanner
                ...
                desc='Seamlessly connect your SAP and non-SAP systems with YASYA’s Integration & BTP services—accelerate innovation with flexible, scalable, and cost-effective integration solutions.'
                cta={true}
            ...
            <OurStory
                img={yourNewImage}
                subtitle="About Us"
                title="The Right Talent, Exactly When You Need It"
                desc={<>

                    YASYA’s Talent on Demand services enable enterprises to quickly scale SAP capabilities without the delays and costs of traditional hiring. Whether for short-term projects or long-term transformation programs, we provide skilled professionals who integrate seamlessly into your teams.
                    <br/>
                    <br/>
                    </>}
            />
