...
const ERPsystems = () => {
    ...
    const DifferentiatorsData = [
        {
            ...
            description: "Online applications, merit lists, counselling, enrollment automation"
        },
        {
            title: "Class Scheduling",
            description: "Faculty utilization & resource planning"
        },
        {
            title: "Exams & Grading",
            description: "Custom grading systems & progression logic"
        },
        {
            title: "Re-Registration Automation",
            description: "Semester promotion & workflow automation"
        },
        {
            title: "Faculty Development",
            description: "Track publications & achievements"
        },
        {
            title: "Research Management",
            description: "Proposal tracking, funding, ethics, IP management"
        }
    ];
    const FaqData = [
        {
    ...
    return (
        <>
            <AboutBanner
                subtitle=''
                title="Digital Transformation for Modern Education Institutions"
                desc='From admissions to graduation, YASYA enables universities and institutions to build scalable, intelligent, and integrated ERP ecosystems powered by SAP.'
                cta={true}
            ...
            <OurStrengths
                ...
                title="Why Education Needs Transformation"
                desc=''
            ...
            <OurStory
                img={yourNewImage}
                subtitle="OUR EDUCATION SOLUTION"
                title="End-to-End Education ERP Platform"
            ...
            />
            <OurStrengths
                subTitle='SOLUTION DIFFERENTIATORS'
                title={<>Built for Real <br/>Institutional Complexity</>}
                desc=''
                strengths={DifferentiatorsData}
                align="center"
                border="1px solid #7a7980ff"
            />
            {/* <Faq
            ...
            <OurStory
                img={yourNewImage}
                subtitle="WHY YASYA FOR EDUCATION"
                title="Not Just ERP — A Complete Academic Ecosystem"
                desc={<>How can these solutions manage organizations day-to-day business activities, such as accounting, finance, procurement, project management, supply chain, and manufacturing.
                    <br />
                    <br />
                    Enterprise resource planning systems are complete, integrated platforms, either on-premises or in the cloud, managing all aspects of a production-based or distribution business. Furthermore, ERP systems support all aspects of financial management, human resources, supply chain management, and manufacturing with your core accounting function.</>}
            />
              ...
              <FeatureOverview
                subtitle="WHY YASYA FOR EDUCATION"
                title="Case Study – RV University"
                features={FeatureData}
            />
                <OurStory
                    img={yourNewImage}
                    subtitle="ABOUT US"
                    title="About RV University"
                    desc={<>RV College of Engineering (RVCE), established in 1963 in Bengaluru, is a premier engineering institution affiliated with VTU and accredited by NBA and NAAC (A+), offering UG, PG, and Ph.D. programs across various disciplines.
                        <br />
                        <br />
                        Enterprise resource planning systems are complete, integrated platforms, either on-premises or in the cloud, managing all aspects of a production-based or distribution business. Furthermore, ERP systems support all aspects of financial management, human resources, supply chain management, and manufacturing with your core accounting function.</>}
                />
