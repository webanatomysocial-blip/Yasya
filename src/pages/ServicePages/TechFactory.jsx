    ...
    return (
        <>
            <AboutBanner
                subtitle=''
                title="Tech Factory"
                desc='Accelerate innovation with our dedicated technology incubator—delivering cutting-edge solutions, rapid prototyping, and scalable engineering to transform your business.'
                cta={true}
            ...
            <OurStory
                img={yourNewImage}
                subtitle="About Us"
                title="Accelerate Development with Tech Factory"
                desc={<>
